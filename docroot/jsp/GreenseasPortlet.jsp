	...
	<div id="tabs">
		...
		<div id="queryTab">
			<div id='search'>
				...
				<div id='queryOptions'>
					...
					<div id='bbox'>
						<input type="checkbox" id="bboxEnabledCheck" title='Enables the bounding box query' data-qtip2Enabled />
						Enable in query
						<br>
						...
						<br>
						<input type='button' id='toCurrentExtent' value="From map extent" data-qtip2Enabled
							title='Sets bounding box to the current extent of the map' />
						<input type='button' id='anywhereButton' value="Anywhere" data-qtip2Enabled
							title='Sets bounding box to the whole globe' />
						<div>
							<form name="lonlatform">
								<div class='centered'>
									<input type='text' id='top' size="5" data-qtip2Enabled title='Maximum latitude' />
								</div>
								<div class='offcentered'>
									<input type='text' id='left' size="5" data-qtip2Enabled title='Minimum longitude' />
									<input type='text' id='right' size="5" data-qtip2Enabled title='Maximum longitude' />
								</div>
								<div class='centered'>
									<input type='text' id='bottom' size="5" data-qtip2Enabled title='Minimum latitude' />
								</div>

								<br>
								<input type="checkbox" name="updatemapcheck" data-qtip2Enabled
									title='If checked, map will zoom to this area when query is run'>
					...
					<div id='datetime'>
						...
						<br>
						<input type="checkbox" id="monthEnabledCheck" data-qtip2Enabled title='Enables the search-by-month query' />
						Search by month
						<br>
						<br>
					...
					<div id='depth'>
						...
						<input type="checkbox" id="depthEnabledCheck" data-qtip2Enabled title='Enables the depth query'>
						Enable in query
						<br>
						<br>
					...
					<div id='cruiseSelectedDiv'>
						...
						<div>
							<input type="checkbox" id="cruiseEnabledCheck" data-qtip2Enabled title='Enable the Cruise/Station query' />
							Enable in query
						</div>
					...
					<div id='regionSelected'>
						<div>
							<input type="checkbox" id="regionEnabledCheck" data-qtip2Enabled title='Enables the Longhurst region query' />
							Enable in query
						</div>
					...
					<div id='biomes'>
						...
						<input type="checkbox" id="biomesEnabledCheck" data-qtip2Enabled title='Enables the Biomes query' />
						Enable in query
						<input type="checkbox" id="biomesBySphereCheck" data-qtip2Enabled
							title='Enables the option to search by north/south hemisphere - This will rebuild the biomes tree.' />
						Search by north/south hemisphere

						<br>
						Search by Biomes
						<br>
						<div id='biomesList'></div>
					...
					<div id='metadataSelected'>
						...
						<div>
							<input type="checkbox" id="metadataEnabledCheck" data-qtip2Enabled title='Enables the metadata query' />
							Enable in query
						</div>
					...
					<div id='parametersNeeded'>
						...
						<input type="button" id="clearSelectionButton" value="Clear selection" data-qtip2Enabled
							title='Deselect all parameters' />
						<input type="button" id="collapseAllButton" value="Collapse All" data-qtip2Enabled
							title='Collapse all nodes in the list' />
						<input type="button" id="expandAllButton" value="Expand All" data-qtip2Enabled
							title='Expand all nodes in the list' />
						<input type="button" id="toggleOrderPlanktonButton" value="Sort plankton by type" data-qtip2Enabled
							title='Toggle sort by plankton type/size' />
						<input type="button" id="downloadSelectedParInfoButton" value="Download info on selected" data-qtip2Enabled
						...
						<br>
						<div>
							<input type="checkbox" id="qualityFlagsEnabledCheck" data-qtip2Enabled
								title='Include qualityflags for the variables in the output' />
				...
				<br>
				<input type='button' id='filter' value="Run main query" data-qtip2Enabled
					title='Runs the main query based on the enabled queries above. The parameters list does not affect this initial query.' />
				<input type='button' id='filterParameters' value="Filter selected parameters" data-qtip2Enabled
		...
		<div id="parametersTab">
			...
			<div id="exportParametersDiv" class="floatLeft">
				<input type='button' id='exportParameter' value="Export data" disabled data-qtip2Enabled title="Export data" />
		...
		<div id="statsTab">
			...
			<div id='statsOptions'>
				...
				<div id="outerStatistics">
					<div id="statistics">
						<input type="button" id="calculateStatisticsButton" value="Calculate statistics" data-qtip2Enabled
		...
		<div id="matchUpTab">
			<div id='modelOptions'>
				...
				<div id='fileOption'>
					<div>
						<input type="checkbox" id="fileOptionCheck" data-qtip2Enabled title='Use the uploaded file' />
			...
			<input type='button' id='initiateRasterDataButton' value="Initiate raster data" data-qtip2Enabled
		...
		<div id="saveTab">
			<div id='saveAccordionDiv'>
				...
				<div id='saveDiv'>
					...
					<!--  <br><input type="checkbox" id="saveQueryDisableMap" data-qtip2Enabled title='Disables the map for faster execution of queries' />Disable the map-->
					<br>
